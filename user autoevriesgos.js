...
window.addEventListener("load", function () {
    ...
    setTimeout(function () {
        ...
        document.querySelector("#master_DefaultContent_rts_s11542_f32250c").innerHTML = nameUser;

        // Nombre usuario logueado en pestaña editar
        let nameUserEdit = nameUser
        document.querySelector("#master_DefaultContent_rts_s11542_f32250c").value = nameUserEdit;
        ...
        function pestañas() {
            ...
            try {
                ...
                let createLogEditar = document.querySelector("#master_DefaultContent_rts_s11542_f31994c > tbody > tr > td > div > label").textContent
                pest = createLogEditar;
                console.log("pestaña edit - creador edit: " + pest)
            } catch (error) {
                // usuario creador en pestaña ver
                let createLogVista = document.querySelector("#master_DefaultContent_rts_s11542_f31994c > ul > li > div > a").textContent
                pest = createLogVista;
        ...
        function agregarText(pestaña) {
            ...
            if (log == pestaña) {
                ...
                try {  
                    ...
                    document.querySelector("#master_DefaultContent_rts_s11542_f32251c").textContent = '1'
                } catch (error) {
                    console.log("No estamos en la pestaña vista")
                }
                try {
                    // user actual de pestaña edit
                    document.querySelector("#master_DefaultContent_rts_s11542_f32251c").value = '1'
                } catch (error) {
                ...
                try {
                    // user actual de pestaña vista
                    document.querySelector("#master_DefaultContent_rts_s11542_f32251c").textContent = '0'
                } catch (error) {
                    console.log("No estamos en la pestaña vista")
                }
                try {
                    // user actual de pestaña edit
                    document.querySelector("#master_DefaultContent_rts_s11542_f32251c").value = '0'
                } catch (error) {
                    console.log("No estamos en la pestaña edit")
                }
